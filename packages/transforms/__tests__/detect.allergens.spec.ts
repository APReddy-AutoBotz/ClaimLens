...
describe('detectAllergens', () => {
  ...
  it('should handle empty or invalid input', () => {
    ...
    expect(detectAllergens(null as any)).toEqual({ allergens: [], crossContaminationRisk: false });
    expect(detectAllergens(undefined as any)).toEqual({ allergens: [], crossContaminationRisk: false });
  });

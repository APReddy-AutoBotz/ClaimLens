...
import { User, UserSession, Role } from './tenant-models';
 ...
 */
export function isSessionInactive(session: UserSession): boolean {
 ...
 */
export function generateMFAQRCodeURL(email: string, secret: string, issuer: string = 'ClaimLens'): string {

...
import type { TransformFunction, TransformContext, NormalizedMenuItem } from '../types.js';
...
`;
  ...
  describe('Transform Registration and Discovery', () => {
    it('should register multiple transforms and discover them', () => {
      ...
      const transform1: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: []
      });

      const transform2: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: []
      });

      const transform3: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: []
      });
...
`;
      ...
      const step1: TransformFunction = (input) => ({
        text: input + ' [STEP1]',
        modified: true,
        flags: []
      });

      const step2: TransformFunction = (input) => ({
        text: input + ' [STEP2]',
        modified: true,
        flags: []
      });

      const step3: TransformFunction = (input) => ({
        text: input + ' [STEP3]',
        modified: true,
        flags: []
      });
...
`;
      ...
      const flag1: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: [
          {
      ...
      const flag2: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: [
          {
...
`;
      ...
      const passthrough: TransformFunction = (input) => ({
        text: input,
        modified: false,
        flags: []
      });
...
`;
      ...
      const working: TransformFunction = (input) => ({
        text: input + ' [OK]',
        modified: true,
        flags: []
      });

      const failing: TransformFunction = () => {
      ...
      expect(verdict.reasons.some(r => 
        r.transform === 'failing' && r.why.includes('Transform crashed')
      )).toBe(true);
    });
...
`;
      ...
      const registered: TransformFunction = (input) => ({
        text: input + ' [REG]',
        modified: true,
        flags: []
      });
...
`;
      ...
      const slowTransform: TransformFunction = async (input) => {
      ...
      const fastTransform: TransformFunction = (input) => ({
        text: input + ' [FAST]',
        modified: true,
        flags: []
      });
      ...
      expect(verdict.reasons.some(r => 
        r.transform === 'slow' && r.why.includes('timeout')
      )).toBe(true);
...
`;
      ...
      const async1: TransformFunction = async (input) => {
      ...
      const async2: TransformFunction = async (input) => {
        await new Promise(resolve => setTimeout(resolve, 10));
        return {
          text: input + ' [ASYNC2]',
          modified: true,
...
`;
      ...
      const redactPii: TransformFunction = (input) => {
      ...
      const detectAllergens: TransformFunction = (input) => {
      ...
      const rewriteDisclaimer: TransformFunction = (input) => {

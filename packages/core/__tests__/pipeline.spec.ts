...
describe('TransformRegistry', () => {
  ...
  it('should register a transform', () => {
    const mockTransform: TransformFunction = (input) => ({
      text: input,
      modified: false,
      flags: []
    });
  ...
  it('should list all registered transforms', () => {
    const transform1: TransformFunction = (input) => ({ text: input, modified: false, flags: [] });
    const transform2: TransformFunction = (input) => ({ text: input, modified: false, flags: [] });
...
describe('TransformPipeline', () => {
  ...
  it('should execute pipeline with no modifications', async () => {
    ...
    const passthroughTransform: TransformFunction = (input) => ({
      text: input,
      modified: false,
      flags: []
    });
  ...
  it('should execute pipeline with modifications', async () => {
    ...
    const modifierTransform: TransformFunction = (input) => ({
      text: input + ' [MODIFIED]',
      modified: true,
      flags: [
        {
  ...
  it('should handle transform errors gracefully', async () => {
    ...
    const failingTransform: TransformFunction = () => {
      throw new Error('Transform failed');
    };

    const workingTransform: TransformFunction = (input) => ({
      text: input + ' [OK]',
      modified: true,
      flags: []
    });

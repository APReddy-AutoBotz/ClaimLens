...
describe('calculateTrustScore', () => {
    ...
    it('should deduct 40 points per banned claim', () => {
        const input = {
            bannedClaimsCount: 2,
            hasRecall: false,
            userAllergensCount: 0,
        ...
        expect(result.breakdown.bannedClaimsDeduction).toBe(80);
        expect(result.breakdown.cleanBonus).toBe(0);
    });
    it('should deduct 30 points for recall', () => {
        const input = {
            bannedClaimsCount: 0,
            hasRecall: true,
            userAllergensCount: 0,
        ...
        expect(result.breakdown.recallDeduction).toBe(30);
        expect(result.breakdown.cleanBonus).toBe(0);
    });
    it('should deduct 20 points per user allergen', () => {
        const input = {
            bannedClaimsCount: 0,
            hasRecall: false,
        ...
        expect(result.breakdown.allergenDeduction).toBe(60);
        expect(result.breakdown.cleanBonus).toBe(0);
    });
    it('should deduct 20 points for weasel word density >20%', () => {
        const input = {
            bannedClaimsCount: 0,
            hasRecall: false,
            userAllergensCount: 0,
        ...
        expect(result.breakdown.weaselWordDeduction).toBe(20);
        expect(result.breakdown.cleanBonus).toBe(0);
    });
    it('should deduct 15 points for weasel word density 10-20%', () => {
        const input = {
            bannedClaimsCount: 0,
            hasRecall: false,
            userAllergensCount: 0,
    ...
    it('should deduct 10 points for weasel word density 5-10%', () => {
        const input = {
            bannedClaimsCount: 0,
            hasRecall: false,
            userAllergensCount: 0,
        ...
        expect(result.breakdown.weaselWordDeduction).toBe(10);
    });
    ...
    it('should handle multiple issues combined', () => {
        ...
        const result = calculateTrustScore(input);
        // 100 - 40 - 30 - 40 - 15 = -25, clamped to 0
        expect(result.score).toBe(0);
        expect(result.breakdown.bannedClaimsDeduction).toBe(40);
        expect(result.breakdown.recallDeduction).toBe(30);
        expect(result.breakdown.allergenDeduction).toBe(40);
        expect(result.breakdown.weaselWordDeduction).toBe(15);
        expect(result.breakdown.cleanBonus).toBe(0);
    });
    ...
    it('should clamp scores above 110 to 110', () => {

 ...
 */
function convertCalories(calories, locale) {
 ...
 * @returns Converted value and unit
 */
function convertWeight(grams, locale) {
 ...
 */
export function normalizeNutrition(nutrition, servingSize, locale = 'en-IN') {
 ...
 */
export function normalizeNutritionTransform(input, context) {
    let nutrition;
    let servingSize;
    try {

 ...
 */
import { sanitizeText, validateInputLength, sanitizeMenuItem, } from '../../../packages/core/input-sanitizer';
/**
...
export function sanitizeRequestBody(req, res, next) {
    ...
    try {
        ...
        if (req.body.items && Array.isArray(req.body.items)) {
            // Menu items array
            req.body.items = req.body.items.map((item) => sanitizeMenuItem(item));
        }
